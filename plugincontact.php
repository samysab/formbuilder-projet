...
function plgesgi_activation(){
    ...
    $wpdb->query("CREATE TABLE IF NOT EXISTS {$wpdb->prefix}contact_data (id INT AUTO_INCREMENT PRIMARY KEY , field_1 VARCHAR(255), field_2 VARCHAR(255),field_3 VARCHAR(255),field_4 VARCHAR(255),field_5 VARCHAR(255));");
}
